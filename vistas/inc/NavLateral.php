    ...
    <div class="full-box nav-lateral-content">
        <figure class="full-box nav-lateral-avatar">
            ...
            <figcaption class="roboto-medium text-center">
                <?php echo $_SESSION['nombre_spm']." ".$_SESSION['apellido_spm'] ?> <br>
                <small class="roboto-condensed-light"><?php echo $_SESSION['usuario_spm'] ?></small>
            </figcaption>
        </figure>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo SERVERURL; ?>item-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista de
                                items</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo SERVERURL; ?>reservation-reservation/"><i class="far fa-calendar-alt fa-fw"></i> &nbsp;
                                Reservaciones</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo SERVERURL; ?>reservation-search/"><i class="fas fa-search-dollar fa-fw"></i> &nbsp; Buscar
                                por fecha</a>
                        </li>
                    </ul>
                </li>
