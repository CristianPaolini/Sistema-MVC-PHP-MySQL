...
<div class="container-fluid">
	<?php
		...
		$datos_cliente = $ins_cliente->datos_cliente_controlador("Unico", $pagina[1]); // $pagina[0] = vista actual, $pagina[1] = id del cliente (encriptado)
				...
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							value="<?php echo $campos['cliente_dni']; ?>" id="cliente_dni" maxlength="27">
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							value="<?php echo $campos['cliente_nombre']; ?>" id="cliente_nombre" maxlength="40">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							value="<?php echo $campos['cliente_apellido']; ?>" id="cliente_apellido" maxlength="40">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							value="<?php echo $campos['cliente_telefono']; ?>" id="cliente_telefono" maxlength="20">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							value="<?php echo $campos['cliente_direccion']; ?>" name="cliente_direccion_up" id="cliente_direccion"
							maxlength="150">
						</div>
					</div>
				</div>
