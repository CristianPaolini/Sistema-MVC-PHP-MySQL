...
<?php
	if (!isset($_SESSION['fecha_inicio_prestamo']) && empty($_SESSION['fecha_inicio_prestamo']) && // Ver buscadorAjax $fecha_inicio = "fecha_inicio_".$modulo; modulo es prestamofinal
			...
			<div class="row justify-content-md-center">
				<div class="col-12 col-md-6">
					<p class="text-center" style="font-size: 20px;">
						Fecha de busqueda: <strong><?php echo date("d-m-Y", strtotime($_SESSION['fecha_inicio_prestamo'])); ?> &nbsp; a
							&nbsp; <?php echo date("d-m-Y", strtotime($_SESSION['fecha_final_prestamo'])); ?></strong>
					</p>
				</div>
				<div class="col-12">
