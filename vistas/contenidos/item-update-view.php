...
<div class="container-fluid">
	<?php
		...
		$datos_item = $ins_item->datos_item_controlador("Unico", $pagina[1]); // $pagina[0] = vista actual, $pagina[1] = id del cliente (encriptado)
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							value="<?php echo $campos['item_codigo']; ?>" id="item_codigo" maxlength="45">
						</div>
					</div>
					...
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							value="<?php echo $campos['item_nombre']; ?>" id="item_nombre" maxlength="140">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="item_detalle_up"
							value="<?php echo $campos['item_detalle']; ?>" id="item_detalle" maxlength="190">
						</div>
					</div>
				</div>
			</div>
